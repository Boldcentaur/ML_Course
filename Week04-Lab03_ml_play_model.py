...
def ml_loop():
    ...
    ball_served = False
    filename = path.join(path.dirname(__file__),"save\clf_KNN_VectorAndDirection.pickle")
    ...
    while True:
        ...
        vector_x = scene_info.ball[0] - s[0]
        vector_y = scene_info.ball[1] - s[1]

        feature.append(vector_x)
        feature.append(vector_y)
